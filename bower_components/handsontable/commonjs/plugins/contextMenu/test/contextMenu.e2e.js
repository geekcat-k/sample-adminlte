...
describe('ContextMenu', function () {
  ...
  describe('beforeContextMenuSetItems hook', function () {
    it('should add new menu item even when item is excluded from plugin settings', _asyncToGenerator(function* () {
    ...
    it('should be called only with items selected in plugin settings', _asyncToGenerator(function* () {
      var keys = [];
