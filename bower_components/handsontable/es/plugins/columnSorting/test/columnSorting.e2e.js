...
describe('ColumnSorting', function () {
  ...
  it('should return sorting state with visual column index under `column` key by the `getSortConfig` method', function () {
    ...
    handsontable({
      data: arrayOfArrays(),
      columns: [{}, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, {}],
      columnSorting: {
  ...
  it('should not throw an exception when clicked on the top-left corner', _asyncToGenerator(function* () {
  ...
  describe('data type: time', function () {
    it('should properly rewrite time into correct format after sort', _asyncToGenerator(function* () {
      handsontable({
  ...
  describe('Click on the header sort data', function () {
    ...
    it('should block action for specific configuration', function () {
      handsontable({
        data: arrayOfArrays(),
        columns: [{ columnSorting: { headerAction: false } }, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, {}],
        colHeaders: true,
        columnSorting: {
          headerAction: true
        }
    ...
    it('should not block action for specific configuration updated by `updateSettings`', function () {
      ...
      updateSettings({ columns: function columns() {
          return { type: 'text' };
        } });
  ...
  describe('rendering headers', function () {
    ...
    it('should not change width of multi-line headers when plugin is enabled / disabled and sort indicator is disabled', _asyncToGenerator(function* () {
      handsontable({
        colHeaders: ['AAA<br>BB']
      });
